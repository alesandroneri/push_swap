...
int ft_is_all_numbers(char *nb)
{
    ...
    i = 0;
    if (nb[0] == '-' || nb[0] == '+')//Verificacao para numero negativo.
        i++;
    while (nb[i] != '\0')
    {
...
//Verificao de argumentos caso sejam passados como uma unica string ou se forem passados como argumentos separados.
